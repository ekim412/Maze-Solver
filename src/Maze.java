 ...
 * <ul>
 * <li>The first line has the number of rows, columns, and exits</li>
 * 
 * <li>Each subsequent line (there will be the same number of lines as rows)</li>
 * </ul>
 *
 *
 * (Note: because this maze is based on hexagons, each alternating row is
...
public class Maze extends JFrame { 
	...
	public Maze(String inFile) throws UnknownMazeCharacterException, FileNotFoundException, IOException{
		...
		numExits = Integer.parseInt(lineTokens.nextToken());
	...
	/**
	 * Returns the minimum number of exits needed to solve the maze successfully.
	 * @return the minimum number of exists
	 */
